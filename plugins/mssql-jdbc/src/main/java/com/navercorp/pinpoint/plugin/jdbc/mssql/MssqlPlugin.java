...
public class MssqlPlugin implements ProfilerPlugin, TransformTemplateAware {
    ...
    private void addConnectionTransformer() {
        transformTemplate.transform("com.microsoft.sqlserver.jdbc.SQLServerConnection", MssqlConnectionTransform.class);
    }
    ...
    private void addDriverTransformer() {
        transformTemplate.transform("com.microsoft.sqlserver.jdbc.SQLServerDriver", DriverTransformer.class);
    }
