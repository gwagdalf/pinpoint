 ...
 * @author Taejin Koo
 */
public class CuratorZookeeperClientIntegrationTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        CuratorZookeeperClientIntegrationTest.class);
...
//    private static String remoteConnectionString = "172.30.247.244:2181";
    private static String remoteConnectionString = "sellhadoop01em.gmarket.nh:2181,sellhadoop02em.gmarket.nh:2181,sellhadoop03em.gmarket.nh:2181";
    private static String PARENT_PATH = "/hbase_unsecure";
...
//        String connectionString = "sellhadoop01em.gmarket.nh:2181,sellhadoop02em.gmarket.nh:2181,sellhadoop03em.gmarket.nh:2181";
        String hbaseClientId = "slick2@ebaykorea.corp";
        String hbaseClientPassword = "R$4summersmilecart";
//        String connectionString = "172.30.247.244:2181";


        curatorZookeeperClient = createCuratorZookeeperClient(remoteConnectionString,"","", eventHoldingZookeeperEventWatcher);
    ...
    private static CuratorZookeeperClient createCuratorZookeeperClient(String connectString, String hbaseClientId, String hbasehbaseClientPassword, EventHoldingZookeeperEventWatcher zookeeperEventWatcher) throws IOException {

        CuratorZookeeperClient curatorZookeeperClient = new CuratorZookeeperClient(connectString,hbaseClientId, hbasehbaseClientPassword,  9000, zookeeperEventWatcher);
//        try{
//            curatorZookeeperClient.createPath("/hbase");
//        }catch(Exception e){
//
//        }
    ...
    private ZooKeeper createZookeeper() throws IOException {
        ZooKeeper zooKeeper = new ZooKeeper(remoteConnectionString, 3000, new EventHoldingZookeeperEventWatcher());
//        ZooKeeper zooKeeper = new ZooKeeper(remoteConnectionString, 3000, new Watcher() {
//            @Override
